...
public class PaintView extends View {
    ...
    public boolean CircleMod = false;
    public boolean RecMod = false;
    ...
    private void touchUp() {
        ...
        if (CircleMod) {
            mPath.addCircle(mX, mY, calculateDistanceBetweenPoints(mX, mY, nX, nY), Path.Direction.CW);
        } else if (RecMod) {
            if (mX > nX) {
                mX = mX + nX - (nX = mX);
                mY = mY + nY - (nY = mY);
            }
            mPath.addRect(mX, mY, nX, nY, Path.Direction.CW);
        } else {
            mPath.lineTo(mX, mY);
        }
    ...
    public void saveImage() {
        ...
        File subDirectory = new File(sdDirectory.toString() + "/DCIM");
